...
- **Segurança**: `validateDestinationPath` agora rejeita caminhos com segmentos `..`, eliminando risco de path traversal na configuração manual do `destinationPath` via `settings.json`
